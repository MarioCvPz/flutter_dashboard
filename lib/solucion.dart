...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      // ============================================================
      // FOOTER: Barra inferior con botones
      // ============================================================
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            _buildFooterButton(icon: Icons.home, label: 'Inicio'),
            _buildFooterButton(icon: Icons.bar_chart, label: 'Gráficos'),
            _buildFooterButton(icon: Icons.receipt, label: 'Transacciones'),
            _buildFooterButton(icon: Icons.settings, label: 'Ajustes'),
          ],
        ),
      ),
      ),
  ...
  /// Construye un botón del footer (barra inferior)
